...
from signals.gen_signal import word_to_binary_signal, binary_to_nrz_signal
...
import numpy as np
from utils.str2bit import nameFromSignal
...
quote = pd.read_csv("data/quotes.csv").iloc[0][3]
v_signal = word_to_binary_signal(quote)
...
plt.savefig('figures/demo_gmsk_quote_signal/binary_signal.pdf', dpi = 300)
...
plt.savefig('figures/demo_gmsk_quote_signal/nrz_signal.pdf', dpi = 300)
...
plt.savefig('figures/demo_gmsk_quote_signal/unoised_modulated_signal.pdf', dpi = 300)
...
plt.savefig('figures/demo_gmsk_quote_signal/noisy_modulated_signal.pdf', dpi = 300)
