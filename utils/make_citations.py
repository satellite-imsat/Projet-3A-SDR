...
characters = ['Lady Galadriel, Commander of the Northern Armies', 'Dark Vador', 'Hubert Bonisseur de La Bath']
movies = ['Lord Of The Ring : The Fellowship of the Ring', 'Star Wars IV : A New Hope', "OSS 177 : Le Caire nid d'espions"]
quotes = ['''Don't be too proud of this technological terror you've constructed. The ability to destroy a planet is insignificant next to the power of the Force''' ,
'''
...
df = pd.DataFrame({"Character" : characters, "Movie" : movies, "Quote" : quotes})
df.set_index(df['Character'])
